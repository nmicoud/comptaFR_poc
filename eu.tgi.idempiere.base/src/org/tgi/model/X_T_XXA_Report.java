...
/** Generated Model for T_XXA_Report
 *  @author iDempiere (generated) 
 *  @version Release 10 - $Id$ */
@org.adempiere.base.Model(table="T_XXA_Report")
public class X_T_XXA_Report extends PO implements I_T_XXA_Report, I_Persistent 
{

	/**
	 *
	 */
	private static final long serialVersionUID = 20221110L;

    /** Standard Constructor */
    public X_T_XXA_Report (Properties ctx, int T_XXA_Report_ID, String trxName)
    {
      super (ctx, T_XXA_Report_ID, trxName);
      /** if (T_XXA_Report_ID == 0)
        {
			setT_XXA_Report_ID (0);
        } */
    }

    /** Standard Constructor */
    public X_T_XXA_Report (Properties ctx, int T_XXA_Report_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, T_XXA_Report_ID, trxName, virtualColumns);
      /** if (T_XXA_Report_ID == 0)
        {
			setT_XXA_Report_ID (0);
        } */
    ...
    /** Load Constructor */
    public X_T_XXA_Report (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_T_XXA_Report[")
	...
	*/
	...
	/** Set T_XXA_Report.
		@param T_XXA_Report_ID T_XXA_Report
	*/
	public void setT_XXA_Report_ID (int T_XXA_Report_ID)
	{
		if (T_XXA_Report_ID < 1)
			set_ValueNoCheck (COLUMNNAME_T_XXA_Report_ID, null);
		else
			set_ValueNoCheck (COLUMNNAME_T_XXA_Report_ID, Integer.valueOf(T_XXA_Report_ID));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_T_XXA_Report_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	*/
	...
	/** Set XXA_DateAsString.
		@param XXA_DateAsString XXA_DateAsString
	*/
	public void setXXA_DateAsString (String XXA_DateAsString)
	{
		set_Value (COLUMNNAME_XXA_DateAsString, XXA_DateAsString);
	}

	/** Get XXA_DateAsString.
		@return XXA_DateAsString	  */
	public String getXXA_DateAsString()
	{
		return (String)get_Value(COLUMNNAME_XXA_DateAsString);
	}

	/** Set XXA_FactAcctOrg.
		@param XXA_FactAcctOrg XXA_FactAcctOrg
	*/
	public void setXXA_FactAcctOrg (String XXA_FactAcctOrg)
	{
		set_Value (COLUMNNAME_XXA_FactAcctOrg, XXA_FactAcctOrg);
	}

	/** Get XXA_FactAcctOrg.
		@return XXA_FactAcctOrg	  */
	public String getXXA_FactAcctOrg()
	{
		return (String)get_Value(COLUMNNAME_XXA_FactAcctOrg);
	}

	/** Set XXA_NumEcriture.
		@param XXA_NumEcriture XXA_NumEcriture
	*/
	public void setXXA_NumEcriture (int XXA_NumEcriture)
	{
		set_Value (COLUMNNAME_XXA_NumEcriture, Integer.valueOf(XXA_NumEcriture));
	}

	/** Get XXA_NumEcriture.
		@return XXA_NumEcriture	  */
	public int getXXA_NumEcriture()
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_XXA_NumEcriture);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
